# Generated by Django 2.2 on 2019-05-05 15:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(default=0)),
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='candidate', to='SAcore.Author')),
                ('participants', models.ManyToManyField(related_name='participants', to='SAcore.Author')),
                ('resource', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SAcore.Resource')),
                ('start_au', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='start_au', to='SAcore.Author')),
            ],
        ),
    ]
